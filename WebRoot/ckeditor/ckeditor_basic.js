	...
	if (!a.editor) {
		...
		a.editor.replace = function(b, c) {
			...
			if (typeof d != 'object') {
				...
				if (!d)
					throw '[CKEDITOR.editor.replace] The element with id or name "'
							+ b + '" was not found.';
			}
		...
		a.editor.appendTo = function(b, c, d) {
			...
			if (typeof e != 'object') {
				...
				if (!e)
					throw '[CKEDITOR.editor.appendTo] The element with id "'
							+ b + '" was not found.';
			}
	...
	if (!a.env)
		a.env = (function() {
			...
			if (d.ie) {
				...
				d.ie7Compat = e == 7 && !document.documentMode
			...
			d.version = e;
			d.isCompatible = d.iOS
					&& e >= 534
					|| !d.mobile
					&& (d.ie && e >= 6 || d.gecko && e >= 10801 || d.opera
							&& e >= 9.5 || d.air && e >= 1 || d.webkit
							&& e >= 522 || false);
			d.cssClass = 'cke_browser_'
					+ (d.ie ? 'ie' : d.gecko ? 'gecko' : d.opera ? 'opera'
							: d.webkit ? 'webkit' : 'unknown');
			if (d.quirks)
				d.cssClass += ' cke_browser_quirks';
			if (d.ie) {
				d.cssClass += ' cke_browser_ie'
						+ (d.version < 7 ? '6'
								: d.version >= 8 ? document.documentMode : '7');
				if (d.quirks)
			...
			a.replaceAll = function() {
				...
				for ( var f = 0; f < e.length; f++) {
					...
					if (typeof arguments[0] == 'string') {
						var i = new RegExp('(?:^|\\s)' + arguments[0]
								+ '(?:$|\\s)');
